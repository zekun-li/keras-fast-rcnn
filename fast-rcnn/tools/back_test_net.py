...
if __name__ == '__main__':
    ...
    for i in range(0,len(roidb)):
        ...
        bbox_label_target = bbox_label_target.astype(np.int32) -1 
        ...
        for ind in range(0, len(bbox_delta_out)):
            if (bbox_label_target[ind] != 0):
                ...
                cnt_20[bbox_label_target] = cnt_20[bbox_label_target]+1
                sum_20[bbox_label_target] = sum_20[bbox_label_target]+ iou
